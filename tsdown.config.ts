/**
 * tsdown build for @fonlan/dsh-quick-commands: the host-half lib (lib/index.js,
 * ESM node) plus the browser client bundle (lib/client.js, CJS closure factory)
 * replicating the official DSH client-bundle preset
 * (packages/client/tsdown.client.ts).
 *
 * The client bundle registers via window.__ModuleLoader__.load({id, factory})
 * with the package-name id `@fonlan/dsh-quick-commands` (the client-modules
 * compose keys on the package name; keep it in sync with package.json `name`).
 */
...
/** The shared CSS-inline virtual-module plugin. */
...
/** One client bundle build for the official profile channel. */
...
export default [
  ...
  clientBundle('@fonlan/dsh-quick-commands'),
